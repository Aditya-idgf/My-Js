...
// edit element from the HTML page
let kid = document.getElementById("NEW-ELEMENT");
// kid.innerHTML = "This is updated code."; // instead of doing it this way , we can do this in a more optimized way
let newKid = document.createElement('p'); // here we created a new element to replace with the old one
newKid.textContent = "This is Opitimized code.";
kid.replaceWith(newKid);

// we can also edit element in this way:
newKid.id = "new-kid";
let changedKid = document.getElementById('new-kid');
changedKid.outerHTML = '<p id = \'outter-kid\'> This is from the outter HTML. </p>';

// remove element
let remChild = document.getElementById('outter-kid');
remChild.remove();